...
# from pixel_classifier_bins import PixelClassifier
import matplotlib.pyplot as plt
# import skimage
# from skimage.measure import label, regionprops
#findcontour https://opencv-python-tutroals.readthedocs.io/en/latest/py_tutorials/py_imgproc/py_contours/py_contour_features/py_contour_features.html
#approxpoly
...
# 	def get_bounding_boxes(self, img,orig_img):
...
# 		print('here is x', x)
		contours_sorted = sorted(contours, key=cv2.contourArea, reverse=True)[:3] #largest 3 boxes
...
# 			cv2.waitKey(0)
			...
			if aspect_ratio <= 2 and aspect_ratio>1 and (w*h>=400 and w*h/float(img.shape[0]*img.shape[1]) > 0.02):
...
# val_image_path = 'C:/Users/s/Google Drive/UCSD GRADUATE CLASSES/2021 WINTER/ECE 276A/pr1/ECE276A_PR1/bin_detection/data/validation/'
# image = val_image_path + '0070.jpg'
# bindet = BinDetector()
...
# cont2 = bindet.get_bounding_boxes(segment,img)
